    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(max_length=28, verbose_name='Phonenumber')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.IntegerField(verbose_name='Price')),
                ('image', models.FileField(blank=True, upload_to='', verbose_name='Image')),
            ],
        ),
        migrations.CreateModel(
            name='NewsItem',
        ...
        migrations.AddField(
            model_name='bid',
            name='auction',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bids', to='auction.Item'),
        ),
        migrations.AddField(
            model_name='bid',
            name='user',
